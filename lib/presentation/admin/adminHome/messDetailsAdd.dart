...
class _MessDetailsAddState extends State<MessDetailsAdd> {
  ...
  Future addMessDetails(Map<String, dynamic> messInfoMap) async {
    return await FirebaseFirestore.instance.collection("messdetails").add(messInfoMap);
  }
    ...
    return Scaffold(
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: () {},
                          child: const Text(
                            'PLEASE TAP TO UPLOAD NON-VEG MENU',
                            style: TextStyle(
                              color: mainColor,
                              fontSize: 15,
                              fontWeight: FontWeight.bold,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          ...
          if (mainImage.isEmpty && vegImage.isEmpty && nonvegImage.isEmpty) {
